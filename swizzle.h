...
#define SWIZZLE_OP(TYPE, SWIZZLE) inline TYPE SWIZZLE () { TYPE result; result.SetType(Temporary); result.m_TemporaryInitialization = xs("%.%", ExtendedName(), SwizzleExtension(Swizzle::SWIZZLE)); return result; }
